...
EOF;
    ...
    public function testObjectSupportEnabled()
    {
        ...
        $this->assertEquals('{ foo: !php/object:O:30:"symfony\yaml\Tests\A":1:{s:1:"a";s:3:"foo";}, bar: 1 }', $dump, '->dump() is able to dump objects');
    }
    ...
    /**
     * @expectedException \symfony\yaml\Exception\DumpException
     */
