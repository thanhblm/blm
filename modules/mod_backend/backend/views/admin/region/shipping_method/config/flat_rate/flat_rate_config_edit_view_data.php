...
<div class="modal-body">
	<?php include_once 'flat_rate_config_edit_form_data.php'; ?>
</div>
...
<script type="text/javascript">
	function addShippingMethodRow(){
		...
		simpleAjaxPost(guid(), "<?=ActionUtil::getFullPathAlias("admin/flat/rate/template/add")?>?rtype=json", data, onAddShippingMethodRowSuccess);
	}
	...
	function removeShippingMethodRow(index){
		var data = $("#edit_shipping_method_setting_form").serialize();
		simpleAjaxPost(guid(), "<?=ActionUtil::getFullPathAlias("admin/flat/rate/template/remove")?>?rtype=json&index=" + index, data, onRemoveShippingMethodRowSuccess);
	}
