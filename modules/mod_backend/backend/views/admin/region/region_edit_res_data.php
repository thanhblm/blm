...
?>
<form class="form-horizontal form-row-seperated" id="edit_region_form" method="post">
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption font-dark">
				<span class="caption-subject bold uppercase"><?=Lang::get('Edit Region')?></span>
			</div>
			<div class="actions btn-set">
				...
				$button->attributes = "type='button' onclick='editRegion()'";
				$button->render ();
				...
				$button->class = "btn btn-sm blue margin-bottom-5";
				$button->attributes = "onclick='editToEditRegion()'";
				$button->render ();
				?>
			</div>
		</div>
			...
			<div class="tabbable-line">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab_general">
						<!-- Begin Tab General -->
						<input type="hidden" id="id" name="region[id]" value="<?=$region->id?>" />
						<div class="form-body">
							<?php
							$text = new TextInput ();
