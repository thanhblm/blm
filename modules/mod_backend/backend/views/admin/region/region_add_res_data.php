...
?>
<form class="form-horizontal form-row-seperated" id="add_region_form" method="post">
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption font-dark">
				<span class="caption-subject bold uppercase"><?=Lang::get('Add Region')?></span>
			</div>
			<div class="actions btn-set">
				...
				$button->attributes = "type='button' onclick='addRegion()'";
				$button->render ();
				...
				$button->class = "btn btn-sm blue margin-bottom-5";
				$button->attributes = "onclick='addToEditRegion()'";
				$button->render ();
				?>
			</div>
		</div>
