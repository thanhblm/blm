...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete Shipping status")?></h4>
</div>
<div class="modal-body">
	<form id="del_shipping_status_form" class="form-horizontal" novalidate="novalidate">
		<input name="id" type="hidden" value="<?=$shippingStatus->id?>" />
		<div class="form-body">
			<p><?=Lang::getWithFormat("Are you sure you want to delete <b>{0}</b>?",$shippingStatus->name)?></p>
		</div>
	</form>
</div>
<div class="modal-footer">
	...
	$button = new Button();
	$button->type = "button";
	$button->id = "btnDelShippingStatus";
