...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete subscriber")?></h4>
</div>
<div class="modal-body">
	<form id="del_subscriber_form" class="form-horizontal" novalidate="novalidate">
		<input name="id" type="hidden" value="<?=$subscriber->id?>" />
		<div class="form-body">
			<p><?=Lang::getWithFormat("Are you sure you want to delete <b>{0}</b>?",$subscriber->email)?></p>
		</div>
	</form>
</div>
