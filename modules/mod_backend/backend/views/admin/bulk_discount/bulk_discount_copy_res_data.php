...
$form->id = "bulk_discount_copy_form";
...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-dark">
            <span class="caption-subject bold uppercase"><?= Lang::get('Clone bulk discount') ?></span>
        </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#iAddBulkDiscountProduct").attr("onclick", "addBulkDiscountProduct('" + countBulkDiscountProduct + "')");
	});
</script>