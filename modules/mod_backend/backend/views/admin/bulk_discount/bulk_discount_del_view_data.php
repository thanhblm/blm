...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete bulk discount")?></h4>
</div>
<div class="modal-body">
	<form id="del_bulk_discount_form" class="form-horizontal" novalidate="novalidate">
		<input name="id" type="hidden" value="<?=$bulkDiscount->id?>" />
		<div class="form-body">
			<p><?=Lang::getWithFormat("Are you sure you want to delete <b>{0}</b>?",$bulkDiscount->name)?></p>
		</div>
	</form>
</div>
