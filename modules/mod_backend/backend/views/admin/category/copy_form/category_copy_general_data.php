...
<div class="form-body">
	...
	<div class="form-group ">
		...
		<div class="col-md-8">
			<input type="radio" name="category[featured]" value="yes" <?php if($category->featured=='yes') echo "checked='checked'";?>><?=Lang::get('Yes')?>&nbsp;
			<input type="radio" name="category[featured]" value="no" <?php if($category->featured=='no') echo "checked='checked'";?>><?=Lang::get('No')?>
		</div>
	</div>
	<?php
