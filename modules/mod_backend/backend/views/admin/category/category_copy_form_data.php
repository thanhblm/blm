...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-dark">
            <span class="caption-subject bold uppercase"><?= Lang::get('Copy category') ?></span>
        </div>
        <div class="actions btn-set">
			...
			$button->attributes = "type='button' onclick='copyAndCloseCategory()'";
			$button->render();

            $button = new Button ();
            $button->title = "<i class='fa fa-plus'></i> " . Lang::get("Save");
            $button->class = "btn btn-sm blue margin-bottom-5";
            $button->attributes = "type='button' onclick='copyCategory()'";
            $button->render();
			?>
        </div>
    </div>
        ...
        <div class="tabbable-line">
            ...
            <div class="tab-content">
	            ...
	            <div class="tab-pane" id="tab_area">
		            <?php include_once 'copy_form/category_copy_area_data.php'; ?>
	            </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function copyCategory(){
        simpleAjaxPost(
            guid(),
            "<?=ActionUtil::getFullPathAlias("admin/category/copy?rtype=json")?>",
            $("#category_copy_form").serialize(),
