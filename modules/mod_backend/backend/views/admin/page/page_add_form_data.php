...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			<span class="caption-subject bold uppercase"><?=Lang::get('Add Page')?></span>
		</div>
		<div class="actions btn-set">
			...
			$button->attributes = "type='button' onclick='addAndClosePage()'";
			$button->render();
			...
			$button->class = "btn btn-sm blue margin-bottom-5";
			$button->attributes = "type='button' onclick='addPage()'";
			$button->render ();
			?>
		</div>
	</div>
...
<script type="text/javascript">
	function addPage(){
	    simpleAjaxPost(
	        guid(),
	        "<?=ActionUtil::getFullPathAlias("admin/page/add?rtype=json")?>",
	        $("#page_add_form").serialize(),
            function (res){
                location.href = "<?=ActionUtil::getFullPathAlias('admin/page/edit/view')?>" + "?pageId=" + res.extra.pageId;
            },
            simpleAjaxPost_fieldErrorCallBack
	    );
	}

	function addAndClosePage(){
	    simpleAjaxPost(
	        guid(),
	        "<?=ActionUtil::getFullPathAlias("admin/page/add?rtype=json")?>",
	        $("#page_add_form").serialize(),
