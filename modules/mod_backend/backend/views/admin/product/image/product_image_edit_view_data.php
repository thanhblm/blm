...
$productImages = RequestUtil::get('productImages');
?>
	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="actions btn-set">
				<?php 
				$link = new Link();
				$link->link =  ActionUtil::getFullPathAlias("file/manager?")."field_id=image_add&pid=product";
		...
		<div>
			...
			<ul class="input_multi_file ui-sortable" id="sortable" style="list-style-type:none">
				<?php 
				$index = 1;
				...
				<li class='input_file input_file_<?=$index?>'>
						...
						<div class="input_file_preview">
							<input type="hidden" class="image_source form-control" value="<?=$imageUrl?>" name=productImages[] id="id_image<?=$index?>">
						...
						<div class="image-action">
							<a class="btn btn-primary popup left" title="Image preview" href="<?=ActionUtil::getFullPathAlias("file/manager?")."field_id=id_image".$index."&pid=product"?>">
								Select image					</a>
