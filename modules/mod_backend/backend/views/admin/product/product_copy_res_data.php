    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption font-dark">
                <span class="caption-subject bold uppercase"><?= Lang::get('Clone Product') ?></span>
            </div>
            <div class="actions btn-set">
				...
				$button->attributes = "type='button' onclick='copyCloseProduct()'";
				$button->render();
				...
				$button->class = "btn btn-sm blue margin-bottom-5";
				$button->attributes = "onclick='copyProduct()'";
				$button->render();
				?>
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_general">
                        ...
                        <div class="form-body">
							...
							$text = new TextArea ();
							$text->errorMessage = RequestUtil::getFieldError("product[composition]");
							$text->hasError = RequestUtil::isFieldError("product[composition]");
