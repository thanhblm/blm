...
?>
<form class="form-horizontal form-row-seperated" id="add_product_form" method="post">
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption font-dark">
                <span class="caption-subject bold uppercase"><?= Lang::get('Add Product') ?></span>
            </div>
            <div class="actions btn-set">
				...
				$button->attributes = "type='button' onclick='addProduct()'";
				$button->render();
				...
				$button->class = "btn btn-sm blue margin-bottom-5";
				$button->attributes = "type='button' onclick='addToEditProduct()'";
				$button->render();
				?>
            </div>
        </div>
        <div class="portlet-body">
            ...
            <div class="tabbable-line">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#tab_price" data-toggle="tab"> <?= Lang::get('Price') ?> </a>
                    </li>
                    <li>
                        <a href="#tab_region" data-toggle="tab"> <?= Lang::get('Region') ?> </a>
                    </li>
                    <li>
                        <a href="#tab_relate" data-toggle="tab"> <?= Lang::get('Related Products') ?> </a>
                    </li>
                    <li>
	                ...
	                <li onclick="javascript:loadProductAttribute();">
		                <a href="#tab_attribute" data-toggle="tab" > <?= Lang::get('Attribute') ?> </a>
	                </li>
                </ul>
                    ...
                    <div class="tab-pane active" id="tab_general">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md-8">
                                		<input type="radio" name="product[featured]" value="yes"><?=Lang::get('Yes')?>&nbsp;
                                		<input type="radio" name="product[featured]" value="no" checked="checked"><?=Lang::get('No')?>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md-8">
                                		<input type="radio" name="product[isSeo]" value="yes"><?=Lang::get('Yes')?>&nbsp;
                                		<input type="radio" name="product[isSeo]" value="no" checked="checked"><?=Lang::get('No')?>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="product[salePrice]" value="0"/>
                        </div>
                        <!-- End Tab General -->
                    </div>
                    <div class="tab-pane" id="tab_language">
						<?php include_once 'lang/product_lang_form_add_data.php'; ?>
                    </div>
                    <div class="tab-pane" id="tab_price">
						<?php include_once 'price/product_price_form_add_data.php'; ?>
                    </div>
                    <div class="tab-pane" id="tab_region">
						<?php include_once 'region/product_region_add_view_data.php'; ?>
                    </div>
                    <div class="tab-pane" id="tab_relate">
						<?php include_once 'relation/product_relation_add_view_data.php'; ?>
                    </div>
                    <div class="tab-pane" id="tab_image">
						<?php include_once 'image/product_image_add_view_data.php'; ?>
                    </div>
                    <div class="tab-pane" id="tab_seo">
						<?php include_once 'seo/product_seo_form_add_data.php'; ?>
                    </div>
	                <div class="tab-pane" id="tab_attribute">
		                <?php include_once 'attribute/product_attribute_form_add_data.php'; ?>
	                </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function loadProductAttribute(){
	    ...
	    simpleAjaxPostUpload(
		    guid(),
		    '<?=ActionUtil::getFullPathAlias("admin/product/attribute")?>?rtype=json&categoryId='+categoryId,
		    "",
