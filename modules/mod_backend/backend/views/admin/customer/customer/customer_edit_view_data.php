...
<div class="modal-header">
	<button type="button" class="close btn-m" data-dismiss="modal" aria-hidden="true"></button>
	<h4 class="modal-title"><?=Lang::get("Edit user")?></h4>
</div>
<div class="modal-body">
	<?php include_once 'customer_edit_form_data.php'; ?>
</div>
