...
<div class="tabbable-line">
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="#tab_account_info" data-toggle="tab"> <?= Lang::get("Account Info") ?> </a>
        </li>
        <li class="">
            <a href="#tab_persional_info" data-toggle="tab"> <?= Lang::get("Personal Info") ?> </a>
        </li>
        <li class="">
            <a href="#tab_company_info" data-toggle="tab"> <?= Lang::get("Company Info") ?> </a>
        </li>
    </ul>
