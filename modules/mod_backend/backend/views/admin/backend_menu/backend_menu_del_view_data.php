...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete backend menu")?></h4>
</div>
<div class="modal-body">
	<form id="del_backend_menu_form" class="form-horizontal" novalidate="novalidate">
		<input name="id" type="hidden" value="<?=$backendMenuVo->id?>" />
		<div class="form-body">
			<p><?=Lang::getWithFormat("Are you sure you want to delete <b>{0}</b>?",$backendMenuVo->title)?></p>
		</div>
	</form>
</div>
