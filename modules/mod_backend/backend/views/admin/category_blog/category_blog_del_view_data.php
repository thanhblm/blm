...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete category blog")?></h4>
</div>
<div class="modal-body" id="del_category_blog_result">
	<?php
	include "category_blog_del_res_data.php";
	?>
</div>
