...
$categoryBlogLangs = RequestUtil::get("categoryBlogLanguages")->getArray();
?>
<div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
        <ul class="nav nav-tabs tabs-left">
			<?php
			$isFirst = true;
			foreach ($categoryBlogLangs as $lang) {
				?>
			...
			foreach ($categoryBlogLangs as $lang) {
                ...
                <div class="tab-pane fade <?= $isFirst ? "active in" : "" ?>" id="localization_<?= $lang->code ?>">
                    <div class="form-body">
						...
						$text = new Text ();
						$text->name = "categoryBlogLanguages[" . $index . "][categoryBlogId]";
						$text->value = $lang->categoryBlogId;
						$text->type = "hidden";
						$text->render();
