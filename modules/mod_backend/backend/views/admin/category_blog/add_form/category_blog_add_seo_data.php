...
$seoInfoLanguages = RequestUtil::get ( "seoInfoLanguages" )->getArray ();
?>
<div class="row">
	<div class="col-md-3 col-sm-3 col-xs-3">
		...
		<?php
		$isFirst = true;
		foreach ( $seoInfoLanguages as $lang ) {
			?>
			<li <?= $isFirst ? "class=\"active\"" : "" ?>><a href="#seo_<?= $lang->code ?>" data-toggle="tab"> <img src="<?= AppUtil::resource_url("global/img/flags/".strtolower($lang->flag).".png") ?>" /> <?= Lang::get($lang->name)?>
                    </a></li>
		<?php
			$isFirst = false;
		}
