	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption font-dark">
				<span class="caption-subject bold uppercase"><?=Lang::get('Edit Blog')?></span>
			</div>
			<div class="actions btn-set">
				...
				$button->attributes = "type='button' onclick='editCloseBlog()'";
				$button->render();
				...
				$button->class = "btn btn-sm blue margin-bottom-5";
				$button->attributes = "onclick='editBlog()'";
				$button->render ();
				?>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="tabbable-line">
				<ul class="nav nav-tabs">
					...
					<li><a href="#tab_relate" data-toggle="tab"> <?=Lang::get('Related Blogs')?> </a></li>
					...
					<div class="tab-pane active" id="tab_general">
						...
						<div class="form-body">
							...
							<div class="form-group ">
								...
								<div class="col-md-8">
									<input type="radio" name="blog[isSeo]" value="yes" <?php if($blog->isSeo=='yes') echo "checked='checked'";?>><?=Lang::get('Yes')?>&nbsp;
	                                <input type="radio" name="blog[isSeo]" value="no" <?php if($blog->isSeo=='no' || AppUtil::isEmptyString($blog->isSeo)) echo "checked='checked'";?>><?=Lang::get('No')?>
                                </div>
							</div>
							...
							$text = new TextInput ();
							$text->errorMessage = RequestUtil::getFieldError ( "blog[crBy]" );
							$text->hasError = RequestUtil::isFieldError ( "blog[crBy]" );
							$text->label = Lang::get ( "Creat By" );
							$text->name = "blog[crBy]";
							$text->value = $blog->crBy;
							$text->render ();
