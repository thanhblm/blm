...
<div class="modal-header">
	...
	<h4 class="modal-title"><?=Lang::get("Delete currency")?></h4>
</div>
<div class="modal-body">
	<form id="del_currency_form" class="form-horizontal" novalidate="novalidate">
		<input name="code" type="hidden" value="<?=$currency->code?>" />
		<div class="form-body">
			<p><?=Lang::getWithFormat("Are you sure you want to delete <b>{0}</b>?",$currency->name)?></p>
		</div>
	</form>
</div>
