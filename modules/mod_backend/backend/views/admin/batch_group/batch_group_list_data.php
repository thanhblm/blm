...
$paging = RequestUtil::get ( "batchGroupList" );
$batchGroupVos = $paging->records;
		...
		<tbody>
			<tr role="row" class="filter">
				...
				<td>
					...
					$button->attributes = "onclick=\"sortBatchGroup()\"";
					$button->render ();
			...
			<?php
			if (empty ( $batchGroupVos ) || count ( $batchGroupVos ) == 0) {
				?>
			<tr role="row">
			...
			<tr class="gradeX odd" role="row">
				...
				<td>
					...
					$select->attributes ="onchange='changeBatchStatus(".$vo->id.", $(this).val(), \"".$vo->name."\")'";
					$select->render ();
					?>
				</td>
				<td>
					...
					$actionBtn->js = "viewBatchGroups($vo->id)";
					...
					$actionBtn->color = ButtonAction::COLOR_BLUE;
					//$actionBtn->js = "editBatchGroupDialog($vo->id)";
					$actionBtn->js = "viewBatchGroups($vo->id)";
					...
					$actionBtn->color = ButtonAction::COLOR_BLUE;
					$actionBtn->js = "copyBatchGroupDialog($vo->id)";
					...
					$actionBtn->js = "deleteBatchGroupDialog($vo->id)";
