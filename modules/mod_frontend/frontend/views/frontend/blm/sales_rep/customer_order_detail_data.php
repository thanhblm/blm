	...
	<table class="table table-striped table-bordered">
		<thead>
			<tr>
				...
				<th class="tax text-center"><?=Lang::get("Tax")?></th>
				...
				<?php foreach ($order->orderTotal as $orderTotal){
                    ...
                    <div class="row static-info align-reverse">
						...
						if($orderTotal->type=='coupon'){
							...
							echo $orderTotal->title.$subtitle.' :';
						}
						?></strong>
						</div>
...
$(document).ready(function(){
	...
	simpleAjaxPost(
		guid(),
		"<?=ActionUtil::getFullPathAlias("customer/salesrep/order/history?rtype=json")?>",
		data,
...
function sendMessageOrder(){
	...
	simpleAjaxPost(
		guid(),
		"<?=ActionUtil::getFullPathAlias("customer/salesrep/order/send/message?rtype=json")?>",
		data,
...
function onSendOrderHistorySuccess(res){
	...
	simpleAjaxPost(
		guid(),
		"<?=ActionUtil::getFullPathAlias("customer/salesrep/order/send/message/view?rtype=json")?>",
		"",
