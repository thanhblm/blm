...
<div class="payment_box payment-method_authorizenet">
	<div style="display: none;"
		...
		$text = new TextInput ();
		$text->type = "text";
		$text->name = "nm_cc_name";
		$text->value = RequestUtil::get ( 'nm_cc_name' );
		$text->required = "required";
		$text->placeholder = "";
		$text->errorMessage = "";
		$text->hasError = RequestUtil::isFieldError ( "nm_cc_name" );
		...
		$select->value = RequestUtil::get ( 'nm_cc_type' );
		;
		$select->name = "nm_cc_type";
		...
		$select->errorMessage = RequestUtil::getFieldError ( "nm_cc_type" );
		$select->hasError = RequestUtil::isFieldError ( "nm_cc_type" );
		...
		$text = new TextInput ();
		$text->type = "text";
		$text->name = "nm_cc_number";
		$text->value = RequestUtil::get ( 'nm_cc_number' );
		$text->required = "required";
		$text->placeholder = "";
		$text->errorMessage = "";
		$text->hasError = RequestUtil::isFieldError ( "nm_cc_number" );
		$text->class = "frm_field frm_text";
		$text->attributes = 'autocomplete="off"';
		$text->render ();
		?>
		...
		<?php
		$select = new SelectInput ();
		$select->value = RequestUtil::get ( 'nm_cc_month' );
		;
		$select->name = "nm_cc_month";
		$select->collections = SelectHelper::getCCMonthArr ();
		$select->collectionType = SelectInput::CT_MULTI_ARRAY_VALUE;
		// $select->label = Lang::get ( "Year" );
		$select->errorMessage = RequestUtil::getFieldError ( "nm_cc_month" );
		$select->hasError = RequestUtil::isFieldError ( "nm_cc_month" );
		$select->required = true;
		$select->render ();
		
		$select = new SelectInput ();
		$select->value = RequestUtil::get ( 'nm_cc_year' );
		;
		$select->name = "nm_cc_year";
		$select->collections = SelectHelper::getCCYearArr ();
		$select->collectionType = SelectInput::CT_MULTI_ARRAY_VALUE;
		// $select->label = Lang::get ( "Year" );
		$select->errorMessage = RequestUtil::getFieldError ( "nm_cc_year" );
		$select->hasError = RequestUtil::isFieldError ( "nm_cc_year" );
		$select->required = true;
		$select->render ();
		?>
		</div>
		...
		$text->type = "text";
		$text->name = "nm_cc_cvv";
		$text->value = RequestUtil::get ( 'nm_cc_cvv' );
		$text->required = "required";
		$text->placeholder = "CVV";
		$text->errorMessage = "";
		$text->hasError = RequestUtil::isFieldError ( "nm_cc_cvv" );
		$text->class = "_short";
