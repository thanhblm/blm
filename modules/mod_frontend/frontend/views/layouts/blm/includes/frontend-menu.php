    ...
    <div class="navbar-nav-wrap">
        <div class="right-side">
            <a class="contact-link"
               href="<?= ActionUtil::getFullPathAlias("home/contact", new AliasUrlFriendly("contact")) ?>"><?= Lang::get('Get in touch with us') ?> </a>
            <div class="btn-group languages rel" style="float: left">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <span><img src="<?= AppUtil::resource_url("global/img/flags/" . strtolower($language->flag) . ".png") ?>"
                               alt="<?= $language->code ?>"
                               title="<?= $language->code ?>"/></span> <?= strtoupper($languageCode) ?>
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="changeLanguage('<?= $lang->code ?>');">
                                    <img src="<?= AppUtil::resource_url("global/img/flags/" . strtolower($lang->flag) . ".png") ?>"
                                         alt="<?= $lang->code ?>"
                                         title="<?= $lang->code ?>"/> <?= strtoupper($lang->code) ?>
                                </a>
                            </li>
                            <?php
                        }
            ...
            if (!is_null($loginCustomerInfo) && $loginCustomerInfo->userId != 0) {
                ...
                if ($loginCustomerInfo->isSaleRepChild) {
                    ...
                    ?>
                    <button type="button" class="btn btn-default dropdown-toggle login" data-toggle="dropdown">
                        <?=$loginCustomerInfo->firstName?>
                        <span class="sprite language-arrow"></span>
                    </button>
            <?php
               ...
               /* $button->attributes = 'data-toggle="dropdown"';
                if ($loginCustomerInfo->isSaleRepChild) {
                    ...
                    $button->title = "<span>" . $loginCustomerInfo->firstName . "<span class=\"sprite language-arrow\"></span>";
                }
                $button->render();*/
                ?>
                <ul class="dropdown-menu " role="menu" id="user-login-menu">
                    ...
                    <li>
                        <a href="<?= ActionUtil::getFullPathAlias("customer/service/list") ?>"><?= Lang::get('My Services') ?></a>
                    </li>
