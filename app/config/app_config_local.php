...
ApplicationConfig::set("action.alias.list", array(
	...
	"how-is-cannabidiol-made-in-hemp" => "home/how/is/cannabidiol/made/in/hemp",
	"what-is-endocannabinoid-system" => "home/what/is/endocannabinoid/system",
	"shopping-cart" => "home/cart/checkout/view",
	"gioi-thieu" => "home/about/us",
	"endoca-lifestyle" => "home/endoca/lifestyle",
	"cbd-relax" => "home/live/in/balance",
	"faq" => "home/faq",
	...
	"anvisa" => "anvisa",
	"can-cannabis-cause-allergic-reactions" => "home/can/cannabis/cause/allergic/reactions",
	"order-confirmation" => "home/order/confirmation",
	"our-hemp" => "home/our/hemp",
	"auto-shipping-details" => "home/auto/shipping/details",
	"will-i-test-positive-for-cannabis-if-i-use-cbd-hemp-oil" => "home/will/i/test/positive/for/cannabis/if/i/use/cbd/hemp/oil",
	...
	"how-to-use-cbd-oil" => "home/how/to/use/cbd/oil",
	"seo-new-content" => "home/seo/new/content",
	"beginners-guide-to-cbd" => "home/beginners/guide/to/cbd",
...
ApplicationConfig::set("language.default.code", "vi");
// Site name.
ApplicationConfig::set('site.name', 'HPD Framework');
ApplicationConfig::set('version', '0.0.1');
ApplicationConfig::set('session.prefix', 'dato');
ApplicationConfig::set('web.context', '/24hbigsale');
// Set production mode.
...
ApplicationConfig::set('db.schema', '24hbigsale');
// Email settings
...
ApplicationConfig::set('email.from.name', "V DATO Solutions");
...
ApplicationConfig::set("page.default.nlinks", "5");
...
// layout constant
ApplicationConfig::set("layout.name", "endoca");
...
// Maxmind user
ApplicationConfig::set("maxmind.user", "120732");
ApplicationConfig::set("maxmind.password", "Z14Tmd7nx550");
